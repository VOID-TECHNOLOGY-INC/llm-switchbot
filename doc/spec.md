...
### 5A.1 自然言語ワークフローパーサー（WorkflowParser）
...
### 5A.2 条件評価エンジン（ConditionEvaluator）
...
### 5A.3 自動化スケジューラー（AutomationScheduler）
